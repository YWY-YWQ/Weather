...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        widget01->setStyleSheet(QString::fromUtf8(""));
...
"border-radius: 7px;"));
        ...
        widget0404->setMinimumSize(QSize(500, 200));
        widget0404->setMaximumSize(QSize(500, 200));
...
""));
        ...
        verticalLayout_7->setStretch(3, 6);
